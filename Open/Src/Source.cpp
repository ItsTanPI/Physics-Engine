...
{    
    ...
    GameObject A(32, 10, Vector2(400, 400) ,Options(1, 0.5f, false, Vector2(-00, 00)));
    GameObject B(32, 10, Vector2(500, 400), Options(1, 0.5f, false, Vector2(-00, 00)));
    GameObject C(32, 10, Vector2(500, 300), Options(1, 0.5f, false, Vector2(-00, 00)));
    GameObject D(32, 10, Vector2(400, 300), Options(1, 0.5f, false, Vector2(-00, 00)));
