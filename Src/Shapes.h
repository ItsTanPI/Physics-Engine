...
public:
    ...
    Shapes() : X(400), Y(400)
    {
        ...
        RD = 25;
        dmp = 0.5f;
        GameObject Temp(4, (RD - 8), Vector2(X, Y), Options(1, 0.25f, false, force));
        Holder = Temp;
        ...
        for (int i = 0; i < shape; i++)
        {
            ...
            GameObject Temp(4, 3, Position, Options(1, 0.25f, false, force));
    ...
    Shapes(float x, float y, bool isStatic = false): X(x), Y(y)
    {
        ...
        RD = 25;
        dmp = 0.5f;
        GameObject Temp(4, (RD - 8), Vector2(X, Y), Options(1, 0.25f, isStatic, force));
        Holder = Temp;
        ...
        {
            Vector2 Position(X + (sin(IndexAngle) * RD), Y + cos(IndexAngle) * RD);
            GameObject Temp(4, 3, Position, Options(1, 0.25f, isStatic, force));
